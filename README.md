...
- **Highly Accurate**: The functions in this package have precision next to the precision of [Wolfram Mathematica and MATLAB](https://github.com/fobos123deimos/fast-wave-benchmarks). In addition, there is a module for calculating wave functions with arbitrary precision using the *mpmath* package.
